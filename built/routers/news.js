...
router.get("/:category", addQuery, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var category, _a, cc, lang, date, date_gt, date_gte, date_lt, date_lte, page, pageNum, pg, _b, top, skip, filters, data;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                category = req.params.category;
                _a = req.query, cc = _a.cc, lang = _a.lang, date = _a.date, date_gt = _a.date_gt, date_gte = _a.date_gte, date_lt = _a.date_lt, date_lte = _a.date_lte, page = _a.page;
                pageNum = Number(page);
